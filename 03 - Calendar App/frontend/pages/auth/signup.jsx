  ...
  return (
    <div className='h-screen flex flex-col justify-center items-center'>
      ...
      <input className="rounded-lg border-2 border-solid border-gray-300 p-2 focus:border-2 focus-visible:border-green-300 focus-visible:outline-none" placeholder='Last name' value={lastname} onChange={(e)=>setLastname(e.target.value)}></input>
       ...
       <input className="rounded-lg border-2 border-solid border-gray-300 p-2 focus:border-2 focus-visible:border-green-300 focus-visible:outline-none" placeholder='Confirm Password' value={repass} onChange={(e)=>setREpass(e.target.value)}></input>
